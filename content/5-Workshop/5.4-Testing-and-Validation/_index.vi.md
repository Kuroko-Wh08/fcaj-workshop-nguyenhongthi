...
![MalScanAI hoạt động qua HTTPS](/images/5-Workshop/5.4-Testing-and-Validation/domain-https.png)
...
![ECS Service đang hoạt động](/images/5-Workshop/5.4-Testing-and-Validation/ecs-service-running.png)
...
![Target Group đạt trạng thái Healthy](/images/5-Workshop/5.4-Testing-and-Validation/target-group-healthy.png)
...
![Truy cập trực tiếp ALB bị từ chối](/images/5-Workshop/5.4-Testing-and-Validation/direct-alb-403.png)
