...
![ECS CPU và Memory metrics](/images/5-Workshop/5.5-Monitoring-and-Alerts/ecs-metrics.png)
...
![Log xử lý của Streamlit](/images/5-Workshop/5.5-Monitoring-and-Alerts/streamlit-log.png)
...
![Log khởi động URL Engine](/images/5-Workshop/5.5-Monitoring-and-Alerts/url-engine-log.png)
...
![Chọn metric UnHealthyHostCount](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-select-metric.png)
...
![Cấu hình điều kiện Alarm](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-conditions.png)

CloudWatch Alarm không sử dụng SNS action trong bước tạo. Alarm vẫn lưu trạng thái và lịch sử trên CloudWatch.

![Không cấu hình SNS action](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-no-actions.png)
...
![CloudWatch Alarm đã được tạo](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-created.png)
...
![Tạo User Notifications configuration](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-rule.png)
...
![Thêm email delivery channel](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-email-channel.png)

![Xác minh địa chỉ email](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-email-verify.png)

Sau khi hoàn tất, notification configuration và email channel ở trạng thái `Active`.

![User Notifications ở trạng thái Active](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-active.png)
