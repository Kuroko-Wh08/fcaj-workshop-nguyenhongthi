...
![ECS CPU and memory metrics](/images/5-Workshop/5.5-Monitoring-and-Alerts/ecs-metrics.png)
...
![Application Load Balancer metrics](/images/5-Workshop/5.5-Monitoring-and-Alerts/alb-metric.png)
...
![Streamlit processing logs](/images/5-Workshop/5.5-Monitoring-and-Alerts/streamlit-log.png)
...
![URL Engine startup logs](/images/5-Workshop/5.5-Monitoring-and-Alerts/url-engine-log.png)
...
![Select UnHealthyHostCount](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-select-metric.png)
...
![Alarm condition configuration](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-conditions.png)

No SNS action is attached during alarm creation. The alarm still records its state and history in CloudWatch.

![No SNS action configured](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-no-actions.png)
...
![Created CloudWatch alarm](/images/5-Workshop/5.5-Monitoring-and-Alerts/alarm-created.png)
...
![Create the User Notifications configuration](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-rule.png)
...
![Add the email delivery channel](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-email-channel.png)

![Verify the email address](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-email-verify.png)

After setup, both the notification configuration and the email channel are `Active`.

![Active User Notifications configuration](/images/5-Workshop/5.5-Monitoring-and-Alerts/user-notification-active.png)
